...
export class Convert {
    public static toSearchGfsResponse(json: string): SearchGifsResponse {
        return cast(JSON.parse(json), r("SearchGfsResponse"));
    }

    public static searchGfsResponseToJson(value: SearchGifsResponse): string {
        return JSON.stringify(uncast(value, r("SearchGfsResponse")), null, 2);
    }
}
